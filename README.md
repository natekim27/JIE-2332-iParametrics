...
```
you need to go to the Azure portal and add your IP address to the list of allowed IP addresses. Do so by going to the query editor in the database and log in with your credentials.
